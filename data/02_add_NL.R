...
for (outcome in outcomes) {
  ...
  amsterdam_nl_file_path <- paste0("/Users/lilsonea/Documents/GitHub/kenniscentrumongelijkheid/data/nl/parents_edu_tab.rds")
...
for (bin in bins) {
  for (lang in langs) {
    file_path <- paste0("/Users/lilsonea/Documents/GitHub/Kansenkloof_Nederland/data/", lang, "/", bin, "_tab_main.csv")
