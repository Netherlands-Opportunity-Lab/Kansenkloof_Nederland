            ...
            fluidRow(
              ...
              column(width = 3,
                     box(height = NULL,
                         ...
                         pickerInput("geografie1_1", label = lang[["area"]], selected = "Amsterdam",
                                     choices = GeoChoices_1,
                                     options = list(`live-search` = TRUE, style = "", size = 10)),
                         uiOutput("geografie1_2"), #a dynamic picker generated in server.R
                     ...
                     box(height = NULL, id="box_groene_group",
                         ...
                         pickerInput("geografie2_1", label = lang[["area"]], selected = lang[["label_the_netherlands"]],
                                     choices = GeoChoices_1,
                                     options = list(`live-search` = TRUE, style = "", size = 10)),
                         uiOutput("geografie2_2"), #a dynamic picker generated in server.R
